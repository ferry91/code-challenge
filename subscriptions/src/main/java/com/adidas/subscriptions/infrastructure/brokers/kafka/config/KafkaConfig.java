...
/**
 * KafkaConfig configuration class, used to configure producer and
 * topics
 */
@Configuration
...
public class KafkaConfig implements WebMvcConfigurer {
	...
	public KafkaAdmin admin() {
		...
		configs.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG,
				springKafkaProperties.getProducer().getBootstrapServers());
	...
	// Create Request-Reply Communications
	@Bean
	public KafkaMessageListenerContainer<String, Object> replyContainerSubscription(ConsumerFactory<String, Message> jsonConsumerFactory) {
		ContainerProperties containerProperties = new ContainerProperties("create_subscription_response");
		return new KafkaMessageListenerContainer(jsonConsumerFactory, containerProperties);
	}

	@Bean
	public ReplyingKafkaTemplate<String, Object, Object> replyKafkaTemplatesubscription(
			KafkaMessageListenerContainer<String, Object> replyContainerSubscription,
			ProducerFactory<String, Object> producerFactory) {
		ReplyingKafkaTemplate<String, Object, Object> replyTemplate = new ReplyingKafkaTemplate(producerFactory, replyContainerSubscription);
